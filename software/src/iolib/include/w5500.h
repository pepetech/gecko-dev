...
#define WIZCHIP_ADDR_OFFSET(ADDR)	(ADDR << 8)
#define WIZCHIP_BLOCK_SELECT_OFFSET(ADDR)	(ADDR << 3)
 ...
 */
#define MR                 (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x0000) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_CREG_BLOCK))
 ...
 */
#define GAR                (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x0001) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_CREG_BLOCK))
 ...
 */
#define SUBR               (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x0005) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_CREG_BLOCK))
 ...
 */
#define SHAR               (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x0009) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_CREG_BLOCK))
 ...
 */
#define SIPR               (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x000F) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_CREG_BLOCK))
 ...
 */
#define INTLEVEL           (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x0013) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_CREG_BLOCK))
 ...
 */
#define IR                 (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x0015) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_CREG_BLOCK))
...
#define IMR                (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x0016) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_CREG_BLOCK))
...
#define SIR                (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x0017) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_CREG_BLOCK))
 ...
 */
#define SIMR               (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x0018) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_CREG_BLOCK))
...
#define RTR                (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x0019) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_CREG_BLOCK))
...
#define RCR                (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x001B) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_CREG_BLOCK))
 ...
 */
#define PTIMER             (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x001C) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_CREG_BLOCK))
 ...
 */
#define PMAGIC             (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x001D) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_CREG_BLOCK))
 ...
 */
#define PHAR                (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x001E) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_CREG_BLOCK))
 ...
 */
#define PSID               (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x0024) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_CREG_BLOCK)))
 ...
 */
#define PMRU               (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x0026) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_CREG_BLOCK)))
 ...
 */
#define UIPR               (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x0028) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_CREG_BLOCK)))
 ...
 */
#define UPORTR              (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x002C) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_CREG_BLOCK)))
 ...
 */
#define PHYCFGR            (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x002E) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_CREG_BLOCK)))
 ...
 */
#define VERSIONR           (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x0039) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_CREG_BLOCK)))
 ...
 */
#define Sn_MR(N)           (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x0000) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_SREG_BLOCK(N)))
 ...
 */
#define Sn_CR(N)           (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x0001) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_SREG_BLOCK(N)))
 ...
 */
#define Sn_IR(N)           (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x0002) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_SREG_BLOCK(N)))
 ...
 */
#define Sn_SR(N)           (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x0003) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_SREG_BLOCK(N)))
 ...
 */
#define Sn_PORT(N)         (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x0004) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_SREG_BLOCK(N)))
 ...
 */
#define Sn_DHAR(N)         (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x0006) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_SREG_BLOCK(N)))
 ...
 */
#define Sn_DIPR(N)         (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x000C) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_SREG_BLOCK(N)))
 ...
 */
#define Sn_DPORT(N)        (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x0010) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_SREG_BLOCK(N)))
 ...
 */
#define Sn_MSSR(N)         (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x0012) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_SREG_BLOCK(N)))
 ...
 */
#define Sn_TOS(N)          (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x0015) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_SREG_BLOCK(N)))
/**
 * @ingroup Socket_register_group
 ...
 * It is set before OPEN command.
 */
#define Sn_TTL(N)          (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x0016) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_SREG_BLOCK(N)))
 ...
 */
#define Sn_RXBUF_SIZE(N)   (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x001E) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_SREG_BLOCK(N)))
 ...
 */
#define Sn_TXBUF_SIZE(N)   (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x001F) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_SREG_BLOCK(N)))
 ...
 */
#define Sn_TX_FSR(N)       (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x0020) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_SREG_BLOCK(N)))
 ...
 */
#define Sn_TX_RD(N)        (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x0022) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_SREG_BLOCK(N)))
 ...
 */
#define Sn_TX_WR(N)        (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x0024) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_SREG_BLOCK(N)))
 ...
 */
#define Sn_RX_RSR(N)       (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x0026) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_SREG_BLOCK(N)))
 ...
 */
#define Sn_RX_RD(N)        (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x0028) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_SREG_BLOCK(N)))
 ...
 * then the carry bit is ignored and will automatically update with the lower 16bits value.
 */
#define Sn_RX_WR(N)        (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x002A) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_SREG_BLOCK(N)))
 ...
 */
#define Sn_IMR(N)          (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x002C) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_SREG_BLOCK(N)))
 ...
 */
#define Sn_FRAG(N)         (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x002D) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_SREG_BLOCK(N)))
 ...
 */
#define Sn_KPALVTR(N)      (W5500_IO_BASE + WIZCHIP_ADDR_OFFSET(0x002F) + WIZCHIP_BLOCK_SELECT_OFFSET(WIZCHIP_SREG_BLOCK(N)))
 ...
 * @param usAddr This Address Phase specifies the 16 bits Offset Address for the W5500 Registers and TX/RX Buffer Blocks
 * @param ubBlockSelect W5500  has  Common  Register,  8  Socket  Register,  TX/RX  Buffer  Block for each Socket.
 * @param ubReadWrite This sets Read/Write Access Mode. Write(1)
 * @param ubOpMode SPI  Operation  Mode  supports  two  modes,  the  Variable Length  Data Mode and the Fixed Length Data Mode.
 * @return The value of register
 */
uint8_t wizchip_read_byte(uint16_t usAddr, uint8_t ubBlockSelect);
 ...
 * @return void
 */
void wizchip_write_byte(uint16_t usAddr, uint8_t ubBlockSelect, uint8_t ubBuf);
 ...
 */
void wizchip_read(uint16_t usAddr, uint8_t ubBlockSelect, uint8_t* pubBuf, uint16_t uslength);
 ...
 * @param len Data length
 */
void wizchip_write(uint16_t usAddr, uint8_t ubBlockSelect, uint8_t* pubBuf, uint16_t uslength);
 ...
 * @sa getMR()
 */
static inline void wizchip_set_MR(mr)
{
	wizchip_write_byte(MR, MR, mr);
}
 ...
 * @sa setMR()
 */
static inline uint8_t wizchip_get_MR()
{
	return wizchip_read_byte(MR, MR);
}
 ...
 * @sa getGAR()
 */
static inline void wizchip_set_GAR(uint8_t *gar)
{
	wizchip_write(GAR, GAR, gar, 4);
}
 ...
 * @sa setGAR()
 */
static inline void wizchip_get_GAR(uint8_t *gar)
{
	wizchip_read(GAR, GAR, gar, 4);
}
 ...
 * @sa getSUBR()
 */
static inline void wizchip_set_SUBR(uint8_t *subr)
{
	wizchip_write(SUBR, SUBR, subr, 4);
}
 ...
 * @sa setSUBR()
 */
static inline void wizchip_get_SUBR(uint8_t *subr)
{
	wizchip_read(SUBR, SUBR, subr, 4);
}
 ...
 * @sa getSHAR()
 */
static inline void wizchip_set_SHAR(uint8_t *shar)
{
	wizchip_write(SHAR, SHAR, shar, 6);
}
 ...
 * @sa setSHAR()
 */
static inline void wizchip_get_SHAR(uint8_t *shar)
{
	wizchip_read(SHAR, SHAR, shar, 6);
}
 ...
 * @sa getSIPR()
 */
static inline void wizchip_set_SIPR(uint8_t *sipr)
{
	wizchip_write(SIPR, SIPR, sipr, 4);
}
 ...
 * @sa setSIPR()
 */
static inline void wizchip_get_SIPR(uint8_t *sipr)
{
	wizchip_read(SIPR, SIPR, sipr, 4);
}
 ...
 * @sa getINTLEVEL()
 */
static inline void wizchip_set_INTLEVEL(uint16_t intlevel)
{
	uint8_t ubBuf[2];
	ubBuf[0] = (uint8_t)(intlevel >> 8);
	ubBuf[1] = (uint8_t)intlevel;
	void wizchip_write(INTLEVEL, INTLEVEL, ubBuf, 2);
}
...
*/
static inline uint16_t wizchip_get_INTLEVEL()
{
	uint8_t ubBuf[2];
	void wizchip_read(INTLEVEL, INTLEVEL, ubBuf, 2);
	return ((uint16_t)ubBuf[0] << 8) + (uint16_t)ubBuf[1];
}
 ...
 * @sa getIR()
 */
static inline void wizchip_set_IR(uint8_t ir)
{
	wizchip_write_byte(IR, IR, (ir & 0xF0));
}
 ...
 * @sa setIR()
 */
static inline uint8_t wizchip_get_IR()
{
	return wizchip_read_byte(IR, IR) & 0xF0;
}
